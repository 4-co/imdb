...
docker run -it --rm retaildevcrews/imdb-import $Imdb_Name $Imdb_Key imdb movies
...
docker run -it --rm retaildevcrews/imdb-import $Imdb_Name $Imdb_Key imdb actors featured genres movies 
